...
func TestLoad_Defaults(t *testing.T) {
	...
	assert.Equal(t, "serpapi", cfg.WebSearchProvider)
...
func TestLoad_FromEnv(t *testing.T) {
	...
	os.Setenv("WEBSEARCH_PROVIDER", "exa")
	os.Setenv("WEBSEARCH_API_KEY", "search-key")
	...
	assert.Equal(t, "exa", cfg.WebSearchProvider)
	assert.Equal(t, "search-key", cfg.WebSearchAPIKey)
